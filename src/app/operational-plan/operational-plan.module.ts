...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'prepare-installation',
        component: PrepareInstallationComponent,
        children: [
          {
            path: '',
            component: CreateInstallationComponent,
            pathMatch: 'full'
          },
          {
            path: 'create-installation/:vesselId',
            component: CreateInstallationComponent
          },
          ...
          {
            path: 'create-documents/:vesselId',
      ...
      {
        path: 'operations-overview/:vesselId',
        component: OperationsOverviewComponent,
        children: [
          {
            path: '',
            component: InstallationOperationsComponent,
            pathMatch: 'full'
          },
          {
            path: 'installation-operations/:vesselId',
            component: InstallationOperationsComponent
          },
          {
            path: 'installation-document/:vesselId',
            component: InstallationDocumentComponent
          },
          {
            path: 'installation-contact/:vesselId',
            component: InstallationContactComponent
          },
          {
            path: 'installation-trade-route/:vesselId',
            component: InstallationTradeRouteComponent
          }
        ]
      }
    ]
